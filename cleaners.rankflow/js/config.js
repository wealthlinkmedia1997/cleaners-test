// ============================================================
// HOUSE CLEANERS Funnel — Configuration
//
// ⚠ THIS IS THE SECOND FUNNEL. Everything below is currently pointing at
// the SAME GoHighLevel calendars, the SAME inbound webhook and the SAME
// Meta pixel as the window tint funnel. If you deploy it as-is, house
// cleaning leads and tint leads land in one undifferentiated pile and the
// pixel optimises both audiences against a single Lead event.
//
// Before running traffic, decide for each of the four values below whether
// you want it shared or separate. At minimum the webhook should be its own,
// so you can tell the two lead sources apart in GHL.
// ============================================================
